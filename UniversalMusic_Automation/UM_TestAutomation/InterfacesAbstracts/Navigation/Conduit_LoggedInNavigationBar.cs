...
// Date July 2018
// Description:
//      Abstract class for the Navigation bar menu items when user is logged in. 
//      
...
{
    public abstract class Conduit_LoggedInNavigationBar
    {
        ...
        public Conduit_LoggedInNavigationBar(IWebDriver p_Driver)
        {            
        ...
        [FindsBy(How = How.XPath, Using =".//ul[@show-authed='true']/li")]
        protected IList<IWebElement> _navbar_items_loggedin { get; set; }
        ...
        public abstract Conduit_LoggedInNavigationBar ClickHomeLink();
        public abstract Conduit_LoggedInNavigationBar ClickNewArticleLink();
        public abstract Conduit_LoggedInNavigationBar ClickSettingsLink();
        public abstract Conduit_LoggedInNavigationBar ClickUsernameLink();
        #endregion
    }
}
